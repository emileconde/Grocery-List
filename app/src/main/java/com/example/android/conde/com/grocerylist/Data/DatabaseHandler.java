package com.example.android.conde.com.grocerylist.Data;
...
import com.example.android.conde.com.grocerylist.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public Grocery getGrocery(int id){
        ...
        if(cursor != null)
            ...
            //return an item in the id column and convert it into an integer
    ...
    public List<Grocery> getAllGroceries(){
        ...
        Constants.KEY_GROCERY_ITEM, Constants.KEY_QTY_NUMBER, Constants.KEY_DATE_NAME},
                null, null, null, null, Constants.KEY_DATE_NAME +
        " DESC");
